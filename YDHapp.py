...
# Update channel_id after input
#new_channelid = st.text_input("Enter the updated Channel ID:", channelid)

# Update channelid if changed
#if new_channelid != channelid:
...
# Button to fetch channel details
...
if st.button("Migrate to MySQL"):
    if channelid:
        ...
        st.warning("Please enter a valid YouTube Channel ID before migrating to MySQL.")
...
def main():
    ...
    if selected_page == "Pre-defined SQL queries":
        predefined_queries()
